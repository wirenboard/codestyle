 ...
 * Докстринги всегда оформляем многострочно — см. раздел [Докстринги](#докстринги).

## Докстринги

Докстринг всегда многострочный, независимо от длины текста:
 * после открывающих `"""` на той же строке ничего не пишем — текст начинается со следующей строки;
 * закрывающие `"""` стоят на отдельной строке.
...
Текущий набор инструментов (black/isort/pylint) это правило не проверяет — соблюдается на ревью.
